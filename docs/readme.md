# nlnz-developer-guidelines documentation
### https://nlnz-developer-guidelines.readthedocs.io/en/latest/
NLNZ Developer Guidelines documentation is written using the ReStructuredText format and hosted on readthedocs.org.
...
The following is the structure committed to the nlnz-developer-guidelines git project. There are additional
...
- source/guides/
    - developer-guide.rst
    - fqa.rst
    - git-development-guide.rst
    - java-development-guide.rst
    - java-user-guide.rst
    - overview-history.rst
    - python-development-guide.rst
    - python-user-guide.rst
...
#### Build
Using the make files located in the nlnz-developer-guidelines docs folder, build the documentation.
